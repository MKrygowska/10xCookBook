...
| 3 | GDPR & content coverage | Prove account deletion cascades correctly; surface ingredient catalog gaps | #5, #6 | integration + manual smoke | complete | context/archive/2026-06-05-testing-gdpr-content-coverage/ |
| 4 | Quality gates wiring | Lock lint + typecheck + unit/integration gates in CI | cross-cutting | CI gates | complete | context/changes/testing-ci-quality-gates/ |
